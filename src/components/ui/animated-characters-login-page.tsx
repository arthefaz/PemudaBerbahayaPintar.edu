      ...
      <div className={`relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground overflow-hidden ${isFlipped ? 'lg:order-2' : ''}`}>
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            ...
            <span className="font-display tracking-wider">PemudaBerbahaya</span>
          </div>
        </div>
      ...
      <div className={`flex items-center justify-center p-8 bg-background ${isFlipped ? 'lg:order-1' : ''}`}>
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Role Selector */}
            <div className="grid grid-cols-2 gap-4 p-1 bg-muted/50 rounded-lg mb-6">
              <button
                type="button"
            ...
            {error && (
              <div className="p-3 text-sm text-red-500 bg-red-500/10 border border-red-500/20 rounded-lg font-medium">
                {error}
              </div>
            )}
